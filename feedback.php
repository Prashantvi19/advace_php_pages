...
<form action="controller.php" method="POST">
 ...
 Massage:
 <textarea name="feedback" class="form-control" rows="3" required="required" placeholder="Please enter your massage here........"></textarea><br>
 
 <input type="submit" class="btn btn-primary" name="feedbackssSubmit" value="Submit">
